...
from optimizers.dpsgd_f_global_adaptive_optimizer import DPSGDFGLOBAL_Adaptive_Optimizer
from torch import optim


class DPSGDFGlobal_Adaptive_PrivacyEngine(PrivacyEngine):
    """
    ...
    def _prepare_optimizer(
        ...
        return DPSGDFGLOBAL_Adaptive_Optimizer(
            optimizer=optimizer,
